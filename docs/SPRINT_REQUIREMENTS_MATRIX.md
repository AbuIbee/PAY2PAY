...
| 12 — Debit Card Sandbox | Card-specific lifecycle, ACH-vs-card fee reallocation | §6–8, §19 (consumes Sprint 3's pricing model) | FR-PAYMETHOD, FR-PRICE (consumes, does not own) | **Changed:** fee-reallocation rule now explicitly documented as reading Sprint 3's pricing model rather than being the only implementation of §19. |
