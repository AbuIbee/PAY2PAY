...
ALTER TABLE "agreement_cancellation_request" ADD CONSTRAINT "agreement_cancellation_request_agreement_id_agreement_id_fk" FOREIGN KEY ("agreement_id") REFERENCES "public"."agreement"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
REVOKE ALL ON "agreement_cancellation_request" FROM anon, authenticated;
